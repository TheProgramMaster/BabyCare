...
The project our team has chosen to complete for this course
 is a Baby Care web application.

This web application is to be used by pregnant women and new
...
Additionally, our web application may be used, not only to select
